...
int main(){
  ...
  cout << "This program gives you the run time in seconds of series of insertions and deletions (based on which of the four files you choose)" << endl;
  cout << " and lets you run these insertions and deletions on a data structure and see its run time in seconds.  " << endl;


  cout<< "File 1 has a series of 250,000 insertions in order from 1 to 250000" << endl;
  cout<<"File 2 has a series of 125,000 insertions in order from 1 to 125000 followed by 125,000 deletions 1 to 125000" << endl;
  cout<<"File 3 has a series of 125,000 insertions in order from 1 to 125000 followed by 125,000 deletions 125000 to 1" << endl;
  cout<<"File 4 has a series of 125000 random, unique insertions from 1 to 125000 followed by 125000 random, unique deletions" << endl;
